...
export const CatIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
      <path d="M14.5 13.03a3.5 3.5 0 0 1-5 0" />
      <path d="M20.9 7.5A4.6 4.6 0 0 0 17.5 6h-11A4.6 4.6 0 0 0 3.1 7.5c-1.1 2.2.4 5.3 4.4 6.2 4.1.9 8.2-.1 9.3-2.4 1.4-2.5 2.3-5.2 4.1-6.3" />
      <path d="M10.1 9.2a1 1 0 1 1-2 0 1 1 0 0 1 2 0Z" />
      <path d="M15.9 9.2a1 1 0 1 1-2 0 1 1 0 0 1 2 0Z" />
  </svg>
);
